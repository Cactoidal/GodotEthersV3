...
var ccip_module = load("res://addons/cactus.godotethers/modules/CCIP/CCIP.tscn")
var ethereal_traveler_module = load("res://addons/cactus.godotethers/modules/EtherealTraveler/EtherealTraveler.tscn")
